...
lamda1=1;lamda2=10000000;reg=0.05;

alpha_mu = (K_trtr+lamda1*eye(train_class))\mu_cap(:,:)';
mu_unk(:,:)=alpha_mu'*K_trte;


logsigmaS=log(sigma_s(:,:)+.0001); % 0.0001 added for stability
